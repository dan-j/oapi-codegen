...
type OutputOptions struct {
	...
	// DisableGodocTypenamePrefix disables the prefixing of type names in godoc comments
	DisableGodocTypenamePrefix bool `yaml:"disable-godoc-typename-prefix,omitempty"`
}
